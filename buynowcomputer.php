...
<div class="main_div">
	...
	<div class="info">
        ...
        <div class="infoimg"><img src="<?php echo $ar['image'];?>" width="300px" height="220px"></div>
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li>Storage Capacity: <?php echo $ar['harddisk']; ?>&nbsp;TB</li>
                <li>RAM:&nbsp;<?php echo $ar['ram'];?>&nbsp;GB</li>
               <li>No. of Cores:&nbsp;<?php echo $ar['core']; ?></li>
                
                <li>Operating System: <?php echo $ar['os']; ?>&nbsp;</li>
