...
<?php
	...
	?>
    <form method="get" action="itemid2.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="itemid2.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
	}}
	?>
