...
<div class="main_div">
	...
	<div class="info">
        ...
        <div class="infoimg"><img src="<?php echo $ar['image'];?>" width="250px" height="170px"></div>
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li>Screen Size: <?php echo $ar['screen']; ?><sup>'</sup></li>
                <li>Surround Sound:&nbsp;<?php echo $ar['surroundsound'];?></li>
               <li>Star Rating:&nbsp;<?php echo $ar['starrating']; ?>&nbsp;Stars</li>
