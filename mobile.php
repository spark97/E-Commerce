...
<div class="main_div">
    ...
    <div class="info">
        ...
        <div class="infoimg"><img src="<?php echo $arr['image'];?>" width="196px" height="400px"></div>
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li>Android Version: <?php echo $arr['Version']; ?></li>
                <li>Wi-Fi Enabled</li>
                <li>Camera:&nbsp;<?php echo $arr['camera']; ?> MP</li>
                
                <li>Processor: <?php echo $arr['core']; ?>&nbsp; GHz</li>
...
<?php
	...
	?>
    <form method="get" action="mobilesuccess.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="mobilesuccess.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
	}}
	?>
