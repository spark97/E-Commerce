...
$query7="select * from tv where itemid like '$itemid' ";
$con7=con();
...
<link type="text/css" rel="stylesheet" href="buynowtelevision.css"/>
...
<div class="main_div">
    ...
    <div class="info">
        ...
        <div class="infoimg"><img src="<?php echo $arr['image'];?>" width="250px" height="170px"></div>
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li>Screen Size: <?php echo $arr['screen']; ?><sup>'</sup></li>
                <li>Surround Sound:&nbsp;<?php echo $arr['surroundsound'];?></li>
               <li>Star Rating:&nbsp;<?php echo $arr['starrating']; ?>&nbsp;Stars</li>
...
<?php
	...
	?>
    <form method="get" action="televisionsuccess.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="televisionsuccess.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
	}}
	?>
