...
$query7="select * from sports where itemid like '$itemid' ";
$con7=con();
...
<link type="text/css" rel="stylesheet" href="buynowsports.css"/>
...
<?php
	...
	?>
    <form method="get" action="sportssuccess.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="sportssuccess.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
