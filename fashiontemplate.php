...
$query7="select * from fashion where itemid like '$itemid' ";
$con7=con();
...
<link type="text/css" rel="stylesheet" href="buynowfashion.css"/>
    ...
    <div class="info">
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li><?php echo $arr['data1']; ?></li>
                <li>Colour:&nbsp;<?php echo $arr['colour'];?></li>
               <li><?php echo $arr['data2']; ?></li>
...
<?php
	...
	?>
    <form method="get" action="fashionsuccess.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="fashionsuccess.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
