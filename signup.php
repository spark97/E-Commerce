...
<div class="main">
  <div class="leftsidebar">
    <ul>
		...
		<li><a href="fashion.php" >Fashion & Lifesyle</a></li>
  ...
  <div class="form">
    <form  name="harshit1" action="register.php" method="post">
          <fieldset>											
		<legend><font size="+3" face="Gill Sans, Gill Sans MT, Myriad Pro, DejaVu Sans Condensed, Helvetica, Arial, sans-serif" color="#940B0E"><b>Sign Up</b></font></legend>            
			<table align="center" height="500px">
				...
				<tr>
                    ...
                    <td><label><input type="number"   name="number" placeholder="Enter your Contact No."required maxlength="10" min="10"></label></td>
                </tr>
