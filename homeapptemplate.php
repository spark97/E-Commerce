...
$query7="select * from home where itemid like '$itemid' ";
$con7=con();
...
<link type="text/css" rel="stylesheet" href="buynowhomeapp.css"/>
...
<div class="main_div">
    ...
    <div class="info">
        ...
        <div class="infoimg"><img src="<?php echo $arr['image'];?>" width="220px" height="250px"></div>
        ...
        <div class="productinfo" style="font-family:Comic Sans MS">
           ...
           <tr><td style="padding:20px; text-decoration:underline"><font size="+2"><b>KEY FEATURES</b></font></td></tr>
            ...
            <tr><td>
            <ul>
            	<li>Capacity: <?php echo $arr['capacity']; ?>&nbsp;litres</li>
                <li>Power:&nbsp;<?php echo $arr['power'];?>&nbsp;W</li>
...
<?php
	...
	?>
    <form method="get" action="homeappsuccess.php" name="BUY_NOW" ><!--<button type="submit" value="" name="BUY_NOW" class="buynow">BUY NOW-->
    <tr><td align="center"><a href="homeappsuccess.php?id=<?php echo $id1;?>"><img src="Images/buynow.png.jpeg"  width="140px" height="68px"></a>
    </form></td></tr>
    <?php
